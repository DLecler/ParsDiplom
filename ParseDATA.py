...
def get_products(list_catalog):
    ...
    for catalog in list_catalog:
        ...
        while True:
            ...
            request_url = f"{url1}{shard}{url2}{query}&page={page}&{poepota}&xsubject=1151&fbrand=275&fcolor=16711680"
            # "https://www.wildberries.ru/catalog/elektronika/detskaya-elektronika?page=1&sort=popular&xsubject=1151&fbrand=275&fcolor=16711680"


            # https://catalog.wb.ru/catalog/electronic36/v2/catalog?cat=58513&page=1&dest=-1255704&ab_testing=false&appType=1&curr=rub&hide_dtype=13&lang=ru&uclusters=3&uiv=0&"uv=AQEAAQIACSFPuZuvbEBouLo5vD2dMKq2sr-SMrcrK6fRO9O2H0MVOm28TDGWu6a1uMGtPo4_EDhlvnDBMkT3QTrEcrSZwp-9QsHsPVa9U727Qd-8E8H6vWoqaD5_O0hBNDzKtEc9bT6avqsv8D7bNeM_wkGGw6LAtD9VwbU_xD7dPlLA9sLSQs4xWMIdwmg8ljthQPO_U8LTQNKwtUJWsRU8kD0SLaU-RELIQOk9GcJxQWC_czclQquxtT1BrIC-LEBzoULCSMU_PKLEA0EKQcY8d0AwM-W5EMBIPWVAOkJGNLo4szdsPn1EFbuqLDu8J70bxZvAUD3HvAQzJkBtv1E5Mz8FxVE&sort=popular&xsubject=1151&fbrand=275&fcolor=16711680
            # {url1}{shard}{url2}{query}&page=1&dest=-1255704&ab_testing=false&appType=1&curr=rub&hide_dtype=13&lang=ru&uclusters=3&uiv=0&"uv=AQEAAQIACSFPuZuvbEBouLo5vD2dMKq2sr-SMrcrK6fRO9O2H0MVOm28TDGWu6a1uMGtPo4_EDhlvnDBMkT3QTrEcrSZwp-9QsHsPVa9U727Qd-8E8H6vWoqaD5_O0hBNDzKtEc9bT6avqsv8D7bNeM_wkGGw6LAtD9VwbU_xD7dPlLA9sLSQs4xWMIdwmg8ljthQPO_U8LTQNKwtUJWsRU8kD0SLaU-RELIQOk9GcJxQWC_czclQquxtT1BrIC-LEBzoULCSMU_PKLEA0EKQcY8d0AwM-W5EMBIPWVAOkJGNLo4szdsPn1EFbuqLDu8J70bxZvAUD3HvAQzJkBtv1E5Mz8FxVE&sort=popular&xsubject=1151&fbrand=275&fcolor=16711680
...
def start_parse(need_CATEGORY, need_ITEM, need_FBRAND, need_FCOLOR):

    category = find_category_with_children("Categories_and_childs.json", need_CATEGORY)
    print(category)
    get_products(json.loads(category))
    write_result_file()